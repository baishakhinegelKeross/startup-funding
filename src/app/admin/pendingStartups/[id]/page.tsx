...
const pitch = `<div class="pitch-section">
  <h1><strong>Pitch for InnovateX: Accelerating Ideas into Impact</strong></h1>
  ...
  <p>
    ...
    <strong>InnovateX</strong> bridges this gap by creating a robust platform that empowers innovators to bring their ideas to life, unlocking unprecedented opportunities for growth and success.
  </p>
  ...
  <p>
    InnovateX is a <strong>platform-driven accelerator</strong> designed to address these inefficiencies. We leverage cutting-edge technology to curate, assess, and support promising startups while ensuring investors gain access to high-quality, de-risked opportunities.
  </p>

  <p>Here’s how InnovateX works:</p>
  <ol>
    <li><strong>Startup Onboarding</strong>: Entrepreneurs submit their ideas through our platform, where AI-powered analysis evaluates their market potential, feasibility, and scalability.</li>
    <li><strong>Mentorship Matching</strong>: We connect startups with industry-specific mentors, enabling guided development and strengthening business models.</li>
    <li><strong>Investor Opportunities</strong>: Investors gain exclusive access to pre-vetted startups, categorized by sector, growth stage, and risk profile.</li>
    <li><strong>End-to-End Support</strong>: From funding to scaling, InnovateX provides startups with the tools, training, and market insights they need to succeed.</li>
  </ol>

  <h2><strong>Why Invest in InnovateX?</strong></h2>
  <ol>
    <li><strong>Massive Market Potential</strong>: With over 300 million startups worldwide and a global venture capital market projected to reach $1.2 trillion by 2030, the demand for a centralized innovation hub has never been higher.</li>
    <li><strong>Proven Revenue Model</strong>: Our subscription-based model for investors, combined with equity-based partnerships with startups, ensures steady cash flow and long-term growth potential.</li>
    <li><strong>Cutting-Edge Technology</strong>: InnovateX leverages AI, big data, and predictive analytics to identify high-potential startups and track market trends, creating a competitive edge.</li>
    <li><strong>Scalability</strong>: Our platform is designed to scale globally, offering seamless integration with regional markets and creating localized opportunities.</li>
  </ol>
  ...
  <h2><strong>The Ask</strong></h2>
  <p>
    We are seeking <strong>$5 million in funding</strong> to expand our platform’s capabilities, enhance our AI technology, and grow our user base. Your investment will allow us to penetrate key markets, onboard more startups, and create a vibrant, self-sustaining ecosystem of innovation.
  </p>
  ...
  <p><strong>Let’s build the future together. Innovate with InnovateX.</strong></p>
</div>
`
        ...
        <div  className="">
            ...
            <Tabs defaultValue="projectOverview" className="w-full">
                <TabsList className="grid w-full grid-cols-8">
                    <TabsTrigger value="projectOverview">Project Overview</TabsTrigger>
                    <TabsTrigger value="fundingDetails">Funding Details</TabsTrigger>
                    <TabsTrigger value="teamAndBackground">Team & Background</TabsTrigger>
                    <TabsTrigger value="bussinessAndMarket">Business & Market</TabsTrigger>
                    <TabsTrigger value="planningAndExecution">Planning & Execution</TabsTrigger>
                    <TabsTrigger value="legalAndComplaince">Legal & Compliance</TabsTrigger>
                    <TabsTrigger value="contactInformation">Contact Information</TabsTrigger>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-2 max-h-96 overflow-auto">
                            <div className="space-y-1">
                                <Label htmlFor="current">Comment</Label>
                                <Textarea id="current" className="min-h-80"  placeholder="enter your comment"/>
                            </div>
                        </CardContent>
                        <CardFooter>
                            <Button className="me-2">Request Changes</Button>
